    ...
    render(){
        return(
            ...
            <header className="text-white body-font bg-slate-900">
                ...
                <a className="mr-5 hover:cursor-pointer" href="#">Insertion Sort</a>
                <a className="mr-5 hover:cursor-pointer" href="#">Selection Sort</a>
                <a className="mr-5 hover:cursor-pointer" href="#">Bubble Sort</a>
                </nav>
